  ...
  const handleEmail = async (e: React.FormEvent) => {
    ...
    try {
      if (mode === "signup") {
        ...
        toast({ title: "Bestätigungs-E-Mail gesendet", description: "Bitte überprüfe dein Postfach." });
      } else {
        ...
        <div className="space-y-4 pt-2">
          ...
          <form onSubmit={handleEmail} className="space-y-3">
            ...
            <Button
              type="submit"
              disabled={loading}
              className="w-full rounded-xl h-12 font-semibold bg-primary text-primary-foreground"
            >
